          ...
          <nav aria-label="breadcrumb">
            <ul class="breadcrumb">
              <li class="breadcrumb-item active" aria-current="page">
                <span></span>Ver Aula <i class="mdi mdi-alert-circle-outline icon-sm text-primary align-middle"></i>
              </li>
            </ul>
          </nav>
        </div>
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card" :class="ficheiros.length == 0 ? 'text-center' : ''">
                    <div class="card-body">
                        ...
                        <div v-else>
                            <h3>Não existe ficheiros nesta aula</h3>
                        </div>
                    </div>
                </div>
            </div>
...
@Component
export default class VerAula extends Vue {
    private aula = null;
    private fileId = 0;
